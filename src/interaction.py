...
def create_vacancy_object(vac_data_list):
    """функция создания объектов вакансий"""
    vac_obj_list = []
...
def filtered_vac_from_salary_range(sort_vac_obj_list):
    """функция отбирает вакансии по зарплатной вилке"""
...
def filtered_vac_from_keywords(sort_vac_obj_list):
    """функция сортирует вакансии по ключевым словам"""
...
def final_func(filter_keyword_vac_obj_list, search_vacancy):
    """функция выводит список оставшихся вакансия и сохраняет их в файл"""
